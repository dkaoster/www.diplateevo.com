<script>
  ...
  export let siteName = 'Diplateevo';
  export let locale = 'en_US';
</script>

<svelte:head>
  <title>{title} - Diplateevo</title>
  ...
  <meta property="og:image" content={`https://www.diplateevo.com${image}`} />
  <meta property="og:site_name" content={siteName || title} />
  <meta property="og:locale" content={locale} />
  {#if description}<meta property="og:description" content={description}>{/if}

  <meta name="twitter:image" content={`https://www.diplateevo.com${image}`}>
